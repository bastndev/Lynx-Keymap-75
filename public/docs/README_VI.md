...
<p align="center">
  ...
  <a href="https://github.com/bastndev/Lynx-Keymap-75/blob/main/public/docs/README_RU.md">Русский 🇷🇺</a><span>...</span>
</p>
...
>
> - Nếu **terminal** đang chiếm bảng điều khiển bên → đóng terminal.
...
> Để sử dụng các lệnh này, trước tiên bạn phải đi tới **Source Control** (vì chúng không hoạt động trực tiếp) hoặc nhấn phím tắt **_`Ctrl + 2`_**.
...
| Xem trước Markdown | `Page Up`       | `Page Up`             |
...
> [!IMPORTANT]
>
> **`Dấu huyền` (Backtick) = ( ` )** hỗ trợ tất cả các bố cục bàn phím 🌎
>
> ```ts
> exports.BACKTICK_EQUIVALENTS = [
>   { Backquote: "`" }, // Tiếng Anh, US
>   { Backquote: "º" }, // Tiếng Tây Ban Nha (Spain)
>   { Backquote: "'" }, // Tiếng Pháp, Tiếng Đức
...
>   { Backquote: "|" }, // Tiếng Tây Ban Nha (Latin America)
>   { Backquote: "¬" }, // Anh, Latin America
>   { Backquote: "¨" }, // Tiếng Đức, Thụy Điển
>   { Backquote: "´" }, // Tiếng Bồ Đào Nha (Latin America)
>   { Backquote: "₺" }, // Tiếng Thổ Nhĩ Kỳ
>   { Backquote: "₤" }, // Tiếng Ý
>   { Backquote: "" }, // Và NHIỀU HƠN NỮA...
> ];
> ```
