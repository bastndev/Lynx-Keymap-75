...
| :------------------------- | :--------------- | :--------------- | :--------------- |
| プロジェクト端末を切り替え | `Alt + Q - W`    | `Alt + Q - W`    | `Alt + Q - W`    |
| 端末を閉じる               | `Alt + Q - E`    | `Alt + Q - E`    | `Alt + Q - E`    |
| -                          | -                | -                | -                |
| opencode/ClaudeCode を開く | `Alt + CapsLock` | `Alt + CapsLock` | `Alt + CapsLock` |
...
| 新しいターミナル                     | <code>⌘ + \`</code>     | <code>Ctrl + \`</code>       |  ✅  |
...
| -                                    | -                       | -                            | N/A  |
| **スマートクローズ** — AIまたは端末  | `⌘ + CapsLock`          | `Ctrl + CapsLock`            |  ✅  |
...
> **スマートクローズ** (`Ctrl + CapsLock`) は状況に応じて機能します:
>
> - **ターミナル** がサイドパネルを占有している場合 → ターミナルを閉じます。
> - それ以外の場合 → **AIチャット** を開く/閉じます。

---

## 🔀 Git

> これらのコマンドを使用するには、まず **ソース管理 (Source Control)** に移動するか（直接動作しないため）、ショートカット **_`Ctrl + 2`_** を押す必要があります。

| コマンド                   | 🍎 macOS         | 🟦 Windows / 🐧 Linux |
| :------------------------- | :--------------- | :-------------------- |
| すべてステージ             | `⌥ + 1`          | `Alt + 1`             |
| AIコミットメッセージを生成 | `⌥ + 2`          | `Alt + 2`             |
| すべてステージ解除         | `⌥ + 3`          | `Alt + 3`             |
...
| コマンド         | 🍎 macOS     | 🟦 Windows / 🐧 Linux |
| :--------------- | :----------- | :-------------------- |
| デバッグの開始   | `Insert`     | `Insert`              |
| デバッグの再起動 | `⌥ + Insert` | `Alt + Insert`        |
| デバッグの停止   | `⌘ + Insert` | `Ctrl + Insert`       |
